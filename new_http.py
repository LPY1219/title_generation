...
def set_args():
    ...
    parser.add_argument('--output_dir', default='model/checkpoint-99664', type=str, help='模型文件路径')
    ...
    def response_request():
        if request.method == 'POST':
            ...
            for i, t in enumerate(titles):
                title_str += "生成的第{}个标题为：{}\n".format(i+1, t)
            return render_template("title_generate.html", content=content, titles=title_str)
        return render_template("title_index.html")
